...
$sort = $_SESSION["sort"];
    ...
    $rows = $conn->query("SELECT * FROM produkty WHERE status >= 1 AND jmeno LIKE '%$hledani%' ORDER BY $sort");
    $allRows = $rows->fetch_assoc();

    $vyprodano = $conn->query("SELECT * FROM produkty WHERE status = 0 AND jmeno LIKE '%$hledani%' ORDER BY $sort");
    $vseVyprodano = $vyprodano->fetch_assoc();
?>
<div class="container-c">
    ...
    <div class="container-b">
        ...
        <div id="sort-links" class="sort-div">
            <div class="sort">
                <a href="search.php?sort=levne<?php echo isset($_GET['min_price']) ? '&min_price=' . $_GET['min_price'] : ''; ?><?php echo isset($_GET['max_price']) ? '&max_price=' . $_GET['max_price'] : ''; ?><?php echo (isset($_GET["hledani"]) ? '&hledani=' . $hledani : ''); ?>"
                    class="sort-item <?php echo ($_GET['sort'] ?? '') === 'levne' ? 'active' : ''; ?>">Od
                    nejlevnějších</a>
                <a href="search.php?sort=drahe<?php echo isset($_GET['min_price']) ? '&min_price=' . $_GET['min_price'] : ''; ?><?php echo isset($_GET['max_price']) ? '&max_price=' . $_GET['max_price'] : ''; ?><?php echo (isset($_GET["hledani"]) ? '&hledani=' . $hledani : ''); ?>"
                    class="sort-item <?php echo ($_GET['sort'] ?? '') === 'drahe' ? 'active' : ''; ?>">Od
                    nejdražších</a>
                <a href="search.php?sort=nove<?php echo isset($_GET['min_price']) ? '&min_price=' . $_GET['min_price'] : ''; ?><?php echo isset($_GET['max_price']) ? '&max_price=' . $_GET['max_price'] : ''; ?><?php echo (isset($_GET["hledani"]) ? '&hledani=' . $hledani : ''); ?>"
                    class="sort-item <?php echo ($_GET['sort'] ?? '') === 'nove' ? 'active' : ''; ?>">Od
                    nejnovějších</a>
                <a href="search.php?sort=jmenoaz<?php echo isset($_GET['min_price']) ? '&min_price=' . $_GET['min_price'] : ''; ?><?php echo isset($_GET['max_price']) ? '&max_price=' . $_GET['max_price'] : ''; ?><?php echo (isset($_GET["hledani"]) ? '&hledani=' . $hledani : ''); ?>"
                    class="sort-item <?php echo ($_GET['sort'] ?? '') === 'jmenoaz' ? 'active' : ''; ?>">Podle názvu A -
                    Z</a>
                <a href="search.php?sort=jmenoza<?php echo isset($_GET['min_price']) ? '&min_price=' . $_GET['min_price'] : ''; ?><?php echo isset($_GET['max_price']) ? '&max_price=' . $_GET['max_price'] : ''; ?><?php echo (isset($_GET["hledani"]) ? '&hledani=' . $hledani : ''); ?>"
        ...
        <div class="content">
            ...
            <?php foreach($vyprodano as $produkt) : ?>
            <div class="prod">
                <div class="karta">
                    <div class="kartobrazek">
                        <img class="kartaobr" src="obrazky/<?php echo $produkt["obrazek"]; ?>">
